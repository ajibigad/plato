...
public class MovieService implements SortOrderResolver {
    ...
    public Call<MoviePagedResponse> getMoviesSortBy(SortCriteria sortCriteria, SortDirection sortDirection, int pageNum) {
        return movieClient.getMovies(getSortOrderQuery(sortCriteria, sortDirection), pageNum);
    }
    ...
    public String getSortOrderQuery(SortCriteria sortCriteria, SortDirection sortDirection) {
        return sortCriteria.getValue() + "." + sortDirection.getValue();
    }
